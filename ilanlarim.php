        ...
        <div class="content">
            <div class="post">
                ...
                <div class="transaction-list">
                    ...
                    $siparissor=$db->prepare("SELECT * FROM itempazari where satankulid=:id order by id DESC");
                        ...
                        if ($sipariscek['durum']==0) { ?>
                            <div class="transaction-list-item">
                                ...
                                <div class="transaction-list-item-audetay">
                                    <a href="ilan-duzenle.php?id=<?php echo $sipariscek['id']; ?>"  class="button dark" style="margin-top:9px; width:100%;"><span style="color:#ffc000">DÜZENLE</span></a>
                                </div>
                                <?php } ?>
                            </div>
                        <?php } elseif ($sipariscek['durum']==1) { ?>
...
if ($_GET['durum'] == "duzenlemebasarili"){ ?>
        ...
        <script>
            $('body').xmalert({
                ...
                title: 'Onay Mesajı',
                paragraph: 'Düzenleme İşlemi Başarılı!',
            });
        </script>
  <?php } ?>
