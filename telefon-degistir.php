...
<body>
	...
	<div class="section-headline-wrap v3">
		<div class="section-headline">
			<h2>Telefon Değiştir / Doğrulama</h2>
	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="content">
				...
				Yeni telefon numarası tanımlayabilmek için yapmanız gereken bir kaç işlem mevcut Lütfen ilk öncelikle e-mail doğrulama kodu gönder butonuna tıklayınız daha sonra e-mailinize gelen doğrulama kutunu E-Posta Doğrulama Kodu alanına giriniz ve doğrula butotuna basınız. Daha sonra yeni telefon numaranızı girmeniz ve doğrulamanız istenecektir.
				</p>
				</div>
			...
			<div class="content">
				...
				<div class="form-box-item">
					<form id="profile-info-form">
						...
						<!-- INPUT CONTAINER -->
						<div class="input-container half ">
							<label for="files_included" class="rl-label required">E-Posta Doğrulama Kodu </label>
							<input type="text" id="files_included" name="files_included" placeholder="E-posta adresinize gelen kodu girin...">
						</div>
						<!-- /INPUT CONTAINER -->
						
						<div class="clearfix"></div>
						<a href="telefon-onayla.php" class="button mid primary"><span class="primary"><span class="fa fa-arrow-right edit2"></span>Devam Et</span></a>
