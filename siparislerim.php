...
<body>
	...
	<!-- MODAL -->
		<!-- SIPARIS DETAY -->
		<?php include "netting/siparis-detay.php";?>
	<!-- MODAL / END -->
	<!-- HEADER-ON -->
				...
				<div class="transaction-list">
					...
					<div class="transaction-list-item">
						...
						<div class="transaction-list-item-audetay">
                            <a href="" data-scid="<?php echo $sipariscek['siparis_id']; ?>" class="button dark spDetay" style="margin-top:9px; width:100%;"><span style="color:#ffc000">DETAY</span></a>
						</div>
					</div>
						<?php } elseif ($sipariscek['siparis_durum']==1) { ?>
