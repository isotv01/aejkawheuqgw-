...
<body>
	...
	<div class="section-headline-wrap v3">
		<div class="section-headline">
			...
			<p>Anasayfa<span class="separator">/</span>Kullanıcı Paneli<span class="separator">/</span><span class="current-section">Güvenlik Ayarları</span></p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="content">
				...
				<h3><p class="text-header tertiary" style="margin-bottom:10px; margin-top:10px;">GÜVENLİK UYARISI</p></h3>
				<p style="font-size:0.875em;line-height:24px; margin-bottom:10px; text-align:center;">
				Sitemizin sağlamış olduğu hiç bir güvenlik önlemini kullanmıyorsunuz hesap güvenliğiniz için en az 1 adet güvenlik önlemi aktif etmenizi ısrarla tavsiye ederiz</p>
			</div>
				<div class="clearfix"></div>
				</article>
				<!-- /POST -->
			...
			<div class="content">
				...
				<div class="form-box-item">
					...
					<div class="input-container">
						<label class="rl-label ">Mail Onayı İle Giriş </label>
						<hr class="line-separator2">
						<!-- CHECKBOX -->
						...
						<label for="copy_shipping1" class="label-check">
							...
							Hesabınıza giriş sırasında mailinize güvenlik kodu gönderilir.
						</label>
						<!-- /CHECKBOX -->
						<hr class="line-separator2">
					</div>
					...
					<!-- INPUT CONTAINER -->
					<div class="input-container">
						<label class="rl-label ">Sms Onayı ile Giriş </label>
						<hr class="line-separator2">
						<!-- CHECKBOX -->
						<input type="checkbox" form="profile-info-form" id="copy_shipping1" name="copy_shipping1">
						<label for="copy_shipping1" class="label-check">
							<span class="checkbox primary"><span></span></span>
							Hesabınıza giriş sırasında telefonunuza güvenlik kodu gönderilir.
						</label>
						<!-- /CHECKBOX -->
						<hr class="line-separator2">
					</div>
					...
					<!-- INPUT CONTAINER -->
					<div class="input-container">
						<label class="rl-label ">IP Kilitleme  </label>
						<hr class="line-separator2">
						<!-- CHECKBOX -->
						<input type="checkbox" form="profile-info-form" id="copy_shipping1" name="copy_shipping1">
						<label for="copy_shipping1" class="label-check">
							<span class="checkbox primary"><span></span></span>
							Hesabınıza yalnızca eklemiş olduğunuz IP Adreslerinden giriş yapılabilir.<p class="text tertiary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Statik IP Kullanılmıyor iseniz işaretleme yapmayınız)</p>
						</label>
						<!-- /CHECKBOX -->
						<hr class="line-separator2">
					</div>
