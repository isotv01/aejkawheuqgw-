		...
		<div class="section full">
			...
			<!-- HEADLINE -->
				...
				<div class="transaction-list">
                    ...
                    $siparissor=$db->prepare("SELECT * FROM bizesat where kullanici_id=:id order by siparis_id DESC");
					...
					<div class="transaction-list-item">
						...
						<div class="transaction-list-item-utipi2">
							<p class="category featured"><?php echo $sipariscek['urun_ad']; echo " - ";	echo $sipariscek['urun_degeri']; ?></p>
						</div>
						...
						<div class="transaction-list-item-audetay">
                            <a href="" data-scid="<?php echo $sipariscek['siparis_id']; ?>" class="button dark spsDetay" style="margin-top:9px; width:100%;"><span style="color:#ffc000">DETAY</span></a>
						</div>
					</div>
						<?php } elseif ($sipariscek['siparis_durum']==1) { ?>
					...
					<div class="transaction-list-item">
						...
						<div class="transaction-list-item-utipi2">
							<p class="category secondary"><?php echo $sipariscek['urun_ad']; echo " - ";	echo $sipariscek['urun_degeri']; ?></p>
						</div>
						...
						<div class="transaction-list-item-utipi2">
							<p class="category primary"><?php echo $sipariscek['urun_ad']; echo " - ";	echo $sipariscek['urun_degeri']; ?></p>
						</div>
						...
						<div class="transaction-list-item-utipi2">
							<p class="category tertiary"><?php echo $sipariscek['urun_ad']; echo " - ";	echo $sipariscek['urun_degeri']; ?></p>
						</div>
        ...
        if($_GET['durum']=="ok"){
            ...
            <script>
                $('body').xmalert({
                    ...
                    title: 'Onay Mesajı',
                    paragraph: 'Satış İşlemi Başarılı! Gerekli Bilgiler Detay sayfasında verilecektir.',
                });
            </script>
        <?php }else{ ?>
