...
<body>
	...
	<div class="section-headline-wrap v3">
		<div class="section-headline">
			<h2>Telefon Değiştir / Onayla</h2>
			<p>Anasayfa<span class="separator">/</span>Kullanıcı Paneli<span class="separator">/</span><span class="current-section">Telefon Değiştir</span></p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="content">
				...
				Şimdi yeni telefon numaranızı yazıp doğrulama kodu gönder butonuna tıklayınız. daha sonra telefonunuza gelen sms deki kodu Telefon Doğrulama Kodu alanına giriniz ve telefon numaranızı güncelleyiniz.</p>
				</div>
				...
				<div class="form-box-item">
					<form id="profile-info-form">
						...
						<div class="input-container ">
							<label for="files_included" class="rl-label required">Yeni Telefon Numaranız </label>
							<input type="text" id="files_included" name="files_included" placeholder="Lütfen yeni telefon numaranızı girin...">
						</div>
						<!-- /INPUT CONTAINER -->
						...
						<a href="#" class="button mid dark"><span class="primary"><span class="fa fa-paper-plane edit2"></span>Doğrulama Kodu Gönder</span></a>
						</div>
						<!-- /INPUT CONTAINER -->
						
						<!-- INPUT CONTAINER -->
						<div class="input-container half ">
							<label for="files_included" class="rl-label required">Telefon Doğrulama Kodu </label>
							<input type="text" id="files_included" name="files_included" placeholder="Telefon doğrulama kodunu girin...">
						</div>
						<!-- /INPUT CONTAINER -->
			
						<div class="clearfix"></div>
						<a href="#" class="button mid primary"><span class="primary"><span class="fa fa-pencil edit3"></span>Güncelle</span></a>
